    ...
    <div class="container"><br>
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-md-8 center-block" style="float: none;">
                <pre><h4>彩虹易支付 - 安装程序|资源来自寻日科技</h4></pre>
                <div class="panel panel-warning">
                    ...
                    <?php } elseif ($step == 4) { ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="list-group-item"><a href="javascript:history.back(-1)" class="btn btn-block btn-info">
                                    << 返回上一页</a>
                            </div>
                        </div>
                    <?php } elseif ($step == 5) { ?>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-group">
                                ...
                                <?php if (!$lock_status) { ?><li class="list-group-item">4、<font color="#FF0033">你的空间不支持本地文件读写，请自行在 /install/ 目录建立 install.lock 文件！</font>
                                    </li><?php } ?>
